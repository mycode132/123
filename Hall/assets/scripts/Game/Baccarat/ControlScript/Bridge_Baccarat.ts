...
subgame_1.gameID = 2134;
subgame_1.gameTime = 30;
subgame_1.gameName = "Baccarat";  //文件夹名字
subgame_1.sceneName = "Hall";
subgame_1.pathOfGamePrefab = "Game/Baccarat/prefab/hall";
subgame_1.pathOfGameExplainPrefab = "Game/Baccarat/prefab/nGameExplain";
subgame_1.classNameOfGamePrefab = "hall_Baccarat";
subgame_1.gameLotteryType = "bjl"

let subgame_2 = new SubgameConfig();
subgame_2.gameID = 2135;
