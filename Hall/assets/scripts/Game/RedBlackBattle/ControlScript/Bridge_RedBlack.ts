...
subgame_1.gameID = 2137;
subgame_1.gameTime = 30;
subgame_1.gameName = "RedBlackBattle";  //文件夹名字
subgame_1.sceneName = "Hall";
subgame_1.pathOfGamePrefab = "Game/RedBlackBattle/prefab/hall";
subgame_1.pathOfGameExplainPrefab = "Game/RedBlackBattle/prefab/nGameExplain";
subgame_1.classNameOfGamePrefab = "hall_RedBlackBattle";
subgame_1.gameLotteryType = "redb"

let subgame_2 = new SubgameConfig();
subgame_2.gameID = 2138;
