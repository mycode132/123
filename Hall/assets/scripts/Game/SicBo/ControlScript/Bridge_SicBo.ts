...
subgame_1.gameID = 2143;
subgame_1.gameTime = 30;
subgame_1.gameName = "SicBo";  //文件夹名字
subgame_1.sceneName = "Hall";
subgame_1.pathOfGamePrefab = "Game/SicBo/prefab/hall";
subgame_1.pathOfGameExplainPrefab = "Game/SicBo/prefab/nGameExplain";
subgame_1.classNameOfGamePrefab = "hall_SicBo";
subgame_1.gameLotteryType = "sicb"

let subgame_2 = new SubgameConfig();
subgame_2.gameID = 2144;
