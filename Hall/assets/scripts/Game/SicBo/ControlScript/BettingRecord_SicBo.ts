...
export default class BettingRecord extends cc.Component {
	...
	@property({type:[cc.SpriteFrame],displayName:"0-4 大小单双"})
	...
	fucUpView(){
		...
		this.node.getChildByName("sheet_15").runAction(cc.scaleTo(0.1,1.0))
		this.m_ScrollView.content.removeAllChildren()	
	}
	...
	fucSetItemInfo(data){
		...
		let betting_number = ["Big","Small","Odd","Even"]
		...
		Item.getChildByName("name").getComponent(cc.Label).string = GameEngine.m_services.i18nSrv.getI18nString("骰宝")  
