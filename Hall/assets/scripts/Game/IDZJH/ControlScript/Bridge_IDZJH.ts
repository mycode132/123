...
subgame_1.gameID = 2149;
subgame_1.gameTime = 30;
subgame_1.gameName = "IDZJH";  //文件夹名字
subgame_1.sceneName = "Hall";
subgame_1.pathOfGamePrefab = "Game/IDZJH/prefab/hall";
subgame_1.pathOfGameExplainPrefab = "Game/IDZJH/prefab/nGameExplain";
subgame_1.classNameOfGamePrefab = "hall_IDZJH";
subgame_1.gameLotteryType = "IDZJH"

let subgame_2 = new SubgameConfig();
subgame_2.gameID = 2150;
