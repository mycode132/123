...
export default class Compare{
	 ...
	 */
	 ...
	 secondCard= 0
	 thirdCard= 0
	 TypeReturn(type, mCard,DCard,TCard) {
		this.handsType = type;  // 手牌类型
		this.maxCard = mCard;   // 最大牌
		this.secondCard = DCard; //第2张
		this.thirdCard = TCard; //第3张
	}
	 ...
	 */
	 fucCardZhuanHuan(cardsArr){
		...
		for (let index = 0; index < cardsArr.length; index++) {
			...
			obj.point = cardsArr[index]%13 != 0 ? cardsArr[index]%13 :13  //点数
			if (obj.point == 1) {
				obj.point = 14
			}
			//花色
			if (cardsArr[index] <= 13) {
				obj.suit = 0
			} else if (cardsArr[index] > 13 && cardsArr[index] <= 26) {
				obj.suit = 1
			} else if (cardsArr[index] > 26 && cardsArr[index] <= 39) {
				obj.suit = 2
			} else {
				obj.suit = 3
			}
	 ...
	 */
	 getHandsType(data) {
		...
		//豹子
		if (cardsArr[0].point == cardsArr[1].point && cardsArr[0].point == cardsArr[2].point) {
			return  new this.TypeReturn(this.JHPaiType.LEOPARD,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
		}
		
		//金花
		else if (cardsArr[0].suit == cardsArr[1].suit  &&  cardsArr[0].suit == cardsArr[2].suit) {
			//顺金 
			if (Math.abs(cardsArr[0].point - cardsArr[1].point) == 1  && Math.abs(cardsArr[1].point - cardsArr[2].point) == 1 )
			{
				return  new this.TypeReturn(this.JHPaiType.SHUNKIN,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
			}
			//1  2  3   最大顺子
			if (cardsArr[0].point == 14 && cardsArr[1].point == 2 && cardsArr[2].point == 3) {
				return  new this.TypeReturn(this.JHPaiType.SHUNKIN,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
			}

			//金花
			return  new this.TypeReturn(this.JHPaiType.JINHUA,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
		}
		//顺子
		else if (Math.abs(cardsArr[0].point - cardsArr[1].point) == 1  && Math.abs(cardsArr[1].point - cardsArr[2].point) == 1 ) {
			return  new this.TypeReturn(this.JHPaiType.SHUNZI,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
		}
		//对子  最大的牌为对子那张
		else if (cardsArr[0].point == cardsArr[1].point  || cardsArr[1].point == cardsArr[2].point || cardsArr[0].point == cardsArr[2].point ) {

			if (cardsArr[0].point == cardsArr[1].point) {
				return  new this.TypeReturn(this.JHPaiType.DUIZI,cardsArr[0].point,cardsArr[2].point,cardsArr[2].point);
			}
			if (cardsArr[1].point == cardsArr[2].point) {
				return  new this.TypeReturn(this.JHPaiType.DUIZI,cardsArr[1].point,cardsArr[0].point,cardsArr[0].point);
			}
			if (cardsArr[0].point == cardsArr[2].point) {
				return  new this.TypeReturn(this.JHPaiType.DUIZI,cardsArr[0].point,cardsArr[1].point,cardsArr[1].point);
			}
		}
		// 1 2 3 顺子
		else if (cardsArr[0].point == 14 && cardsArr[1].point == 2 && cardsArr[2].point == 3) {
			return  new this.TypeReturn(this.JHPaiType.SHUNZI,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
		}
		//单张
		return  new this.TypeReturn(this.JHPaiType.NONE,cardsArr[0].point,cardsArr[1].point,cardsArr[2].point);
	}
	...
	compareHandsReturn(typeReturn1, typeReturn2) {
		if (typeReturn1.handsType !== typeReturn2.handsType) {
			return typeReturn1.handsType > typeReturn2.handsType ? 3 : 5
		}
		else {
			if (typeReturn1.maxCard !== typeReturn2.maxCard) {
				return typeReturn1.maxCard > typeReturn2.maxCard ? 3 : 5
			} else {
				if (typeReturn1.secondCard != typeReturn2.secondCard) {
					return typeReturn1.secondCard > typeReturn2.secondCard ? 3 : 5	
				}else{
					if (typeReturn1.thirdCard != typeReturn2.thirdCard) {
						return typeReturn1.thirdCard > typeReturn2.thirdCard ? 3 : 5	
					}
					return 4  //4和局
				}
			}
