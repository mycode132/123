...
subgame_1.gameID = 2140;
subgame_1.gameTime = 30;
subgame_1.gameName = "FanTan";  //文件夹名字
subgame_1.sceneName = "Hall";
subgame_1.pathOfGamePrefab = "Game/FanTan/prefab/hall";
subgame_1.pathOfGameExplainPrefab = "Game/FanTan/prefab/nGameExplain";
subgame_1.classNameOfGamePrefab = "hall_FanTan";
subgame_1.gameLotteryType = "ft"

let subgame_2 = new SubgameConfig();
subgame_2.gameID = 2141;
